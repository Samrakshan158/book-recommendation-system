...
const BASE_URL = 'https://your-backend-api.com'; // Replace with actual backend URL
let allBooks = []; // Global variable to store all books

// async function fetchRecommendations() {
//     const recommendationsContainer = document.querySelector("#recommendations");

//     // Simulate fetching recommendations from backend
//     fetch("/api/recommendations") // adjust this URL as needed
